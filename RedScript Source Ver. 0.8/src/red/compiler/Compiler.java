		...
		for(int i = 0; i < compiledData.length; i++) {
									...
									if(compiledData[a].equals("Type:Int")) {
										...
										if(title.equals(functions.get(e).name)) {
											...
											for(int q = 0; q < functions.get(e).varInt.size(); q++) {
												...
												if(compiledData[a + 1].charAt(0) != ':') {
													if(functions.get(e).varInt.get(q).value == 0) {
														functions.get(e).varInt.get(q).value = Integer.parseInt(compiledData[a + 1]);
													}
												}
												
												if(compiledData[a + 1].equals(":" + varInt.get(q).name)) {
													
													if(functions.get(e).varInt.get(q).value == 0) {
														functions.get(e).varInt.get(q).value = varInt.get(q).value;
														break;
													}
									...
									if(compiledData[a].equals("Type:String")) {
										...
										if(title.equals(functions.get(e).name)) {
											...
											for(int q = 0; q < functions.get(e).varString.size(); q++) {
												...
												if(compiledData[a + 1].equals(":" + varString.get(q).name)) {
													
													if(functions.get(e).varString.get(q).value.equals("")) {
														functions.get(e).varString.get(q).value = varString.get(q).value;
														break;
													}
			...
			if(compiledData[i].equals("Type:Set")) {
				...
				for(int e = 0; e < varInt.size(); e++) {
					...
					if(compiledData[i + 2].equals("Type:Equals")) {
						
						if(compiledData[i + 3].charAt(0) != ':') {
						...
						if(compiledData[i + 3].charAt(0) == ':') {
							...
							if(compiledData[i + 1].equals(varInt.get(e).name)) {
								...
								for(int q = 0; q < varInt.size(); q++) {
									
									if(compiledData[i + 3].equals(":" + varInt.get(q).name)) {
										varInt.get(e).value = varInt.get(q).value;
										//System.out.println("Value:" + varInt.get(e).value);
										break;
									}
					...
					if(compiledData[i + 2].equals("Type:Add")) {
					...
					if(compiledData[i + 2].equals("Type:Subtract")) {
					...
					if(compiledData[i + 2].equals("Type:Equals")) {
						...
						if(compiledData[i + 3].charAt(0) == ':') {
							...
							if(compiledData[i + 1].equals(varString.get(e).name)) {
								...
								for(int q = 0; q < varString.size(); q++) {
									
									if(compiledData[i + 3].equals(":" + varString.get(q).name)) {
										varString.get(e).value = varString.get(q).value;
										//System.out.println("Value:" + varString.get(q).value);
										break;
									}
			...
			if(compiledData[i].equals("Type:If") && !compiledData[i - 1].equals("Type:End")) {
				...
				if(compiledData[i + 1].equals("Type:Int")) {
					...
					for(int e = 0; e < functions.size(); e++) {
						...
						for(int q = 0; q < functions.get(e).varInt.size(); q++) {
							...
							if(compiledData[i + 3].equals(functions.get(e).varInt.get(q).name)) {
								valueInt = functions.get(e).varInt.get(q).value;
							}
				...
				if(compiledData[i + 1].equals("Type:String")) {
					...
					for(int e = 0; e < functions.size(); e++) {
						...
						for(int q = 0; q < functions.get(e).varString.size(); q++) {
							if(compiledData[i + 3].equals(functions.get(e).varString.get(q).name)) {
								valueString = functions.get(e).varString.get(q).value;
							}
						}
